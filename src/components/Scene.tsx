...
const Scene = forwardRef(({ sceneTransitioning }: { sceneTransitioning: boolean }, ref: ForwardedRef<HTMLDivElement>) => {
  const sceneClassName = useClassName('scene', sceneTransitioning && 'transitioning');
